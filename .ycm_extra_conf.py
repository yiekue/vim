...
def FlagsForFile( filename, **kwargs ):
  if database:
    ...
    # print cmake_flags
    # final_flags.append(cmake_flags[0])
  ...
  temp_path = os.path.join(os.path.abspath(os.path.join(file_dir,"..")),"include")
  temp_flag = "-I"+ temp_path
  if os.path.exists(temp_path) and (temp_flag not in final_flags):
    final_flags.append(temp_flag)

  temp_path = os.path.join(os.path.abspath(os.path.join(file_dir,"..")),"inc")
  temp_flag = "-I"+ temp_path
  if os.path.exists(temp_path) and (temp_flag not in final_flags):
    final_flags.append(temp_flag)
